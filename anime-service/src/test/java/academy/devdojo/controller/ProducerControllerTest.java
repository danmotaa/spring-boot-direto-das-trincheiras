...
class ProducerControllerTest {
    ...
    void init() {
        ...
        var witStudio = Producer.builder().id(2L).name("Wit Studios").createdAt(localDateTime).build();
        var studioGhibli = Producer.builder().id(3L).name("Studios Ghibli").createdAt(localDateTime).build();
    ...
    @Test
    @DisplayName("GET v1/producers?name=Ufotable returns a list with all producers when argument is null")
    @Order(2)
    ...
    @Test
    @DisplayName("GET v1/producers?name=x returns a list with all producers when argument is null")
    @Order(3)
    ...
    @Order(4)
    void findById_ReturnProducerById_WhenSuccess() throws Exception {
    ...
    @Order(6)
    void save_CreatesProducers_WhenSuccessful() throws Exception {
    ...
    @Order(7)
    void update_UpdatesProducers_WhenSuccessful() throws Exception {
    ...
    @Test
    @DisplayName("DELETE v1/producers/1 delete removes a producer")
    @Order(9)
    void delete_RemovesProducers_WhenSuccessful() throws Exception {
